...
//------------------------------------------------------------------------
// StudioOneTestProcessor
//------------------------------------------------------------------------
StudioOneTestProcessor::StudioOneTestProcessor ()
{
	//--- set the wanted controller for our processor
	setControllerClass (kStudioOneTestControllerUID);
}
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::initialize (FUnknown* context)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::terminate ()
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::setActive (TBool state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::process (Vst::ProcessData& data)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::setupProcessing (Vst::ProcessSetup& newSetup)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::canProcessSampleSize (int32 symbolicSampleSize)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::setState (IBStream* state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API StudioOneTestProcessor::getState (IBStream* state)
{
